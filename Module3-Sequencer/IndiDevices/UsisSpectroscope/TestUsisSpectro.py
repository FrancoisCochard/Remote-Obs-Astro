'''
This script is made to test the Indi USIS spectro device
F. Cochard - Jan 2024
'''
import importlib
import yaml
...
data = config_data['UVEX']
print(data, " - ", type(data))

nom_dir = "IndiDevices.UsisSpectroscope"
nom_module = "IndiUsisSpectro"
chemin_module = nom_dir + '.' + nom_module
module = importlib.import_module(chemin_module)
nom_classe = "IndiUsisSpectro"
...
print("__str__ : ", str(instance))
print("__repr__ : ", repr(instance))
