...
class Indi10micronMount(IndiMount):
    """
    Refers to IndiCamera generic device
    """
    ...
    #     """ This is to immediately stop any motion
    #     """
    #     self.logger.debug('Stop Motion')
    #     self.set_switch('TELESCOPE_ABORT_MOTION', ['ABORT'], sync=True, timeout=self.defaultTimeout)
