...
g.set_lock_position(946, 690, exact=True, wait_reached=False, angle_sep_reached=2*u.arcsec)
...
# g.set_lock_position(ret[0]+20, ret[1]+20, exact=True, wait_reached=True, angle_sep_reached=2*u.arcsec)
# g.set_lock_position(946, 691, exact=True, wait_reached=True, angle_sep_reached=2*u.arcsec)
